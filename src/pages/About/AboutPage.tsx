...
const AboutPage = () => {
  ...
  return (
    <section className="isolation min-h-screen w-full bg-[url('/aboutBackground.png')] bg-center flex">
      <div className="bg-[#E9ECF4]/90 w-full relative flex-1 text-slate-900 px-6 flex flex-col items-center justify-between">
        <div className="mt-18 flex-1 max-w-5xl w-full text-center flex flex-col">
          <SectionHeader
            prefix="What is"
            ...
            <div className="flex justify-between gap-12 mt-10 text-left py-10 w-full">
              ...
              <div className="space-y-3 ">
                ...
                <p className="text-base text-slate-500">
                  ...
                  not everyone makes it so while you play together, then
                  betrayals force you back into survival mode.
                </p>
              </div>
